...
const countDevelopers = (arr) => arr.filter((e) => e.continent === 'Europe' && e.language === 'JavaScript').length;
...
// npm run test -- CYF-Array-and-Object-methods/CM_1_Count_the_number_of_JS_devs_coming_from_Europe.js

test('Coding Meetup #1 - Higher-Order Functions Series - Count the number of JavaScript developers coming from Europe', () => {
